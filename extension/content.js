(() => {
  ...
  function showFullscreenBanner() {
    ...
    el.textContent =
      "HACKERRANK CONTEST TRACKING • Fullscreen required • Exit attempts are recorded";
  ...
  function showPasscodeDialog(reason) {
    ...
    let message =
      "Fullscreen is required for this examination. The exit attempt has been recorded. An authorized invigilator must enter the passcode to continue.";

    if (reason === "tab_switch") {
      title = "Screen / Tab Switch Detected";
      message =
        "You switched away from the examination window. This event has been recorded. An authorized invigilator must enter the passcode to continue.";
    }
  ...
  document.addEventListener(
    ...
    (e) => {
      ...
      if (e.repeat) return; // Prevent spamming violations when holding down the key
